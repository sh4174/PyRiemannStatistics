...
# # base.Write( "CMRep_LinearizedGeodesicRegression_CTRL_base.rpt" )
# # tangent.Write( "CMRep_LinearizedGeodesicRegression_CTRL_tangent.tVec" )

# base = manifolds.cmrep( nManDim )
# base.Read( "CMRep_LinearizedGeodesicRegression_CTRL_base.rpt" )

# tangent = manifolds.cmrep_tVec( nManDim ) 
# tangent.Read(  "CMRep_LinearizedGeodesicRegression_CTRL_tangent.tVec"  )
...
# regression_output_folder_path = '/media/shong/IntHard1/4DAnalysis/IPMI2018/GeodesicRegressionResults/CMRep_CTRL_Group_NewCode_Linearized/'
