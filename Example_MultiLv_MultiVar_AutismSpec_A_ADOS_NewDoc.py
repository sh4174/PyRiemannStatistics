...
data_list_pd.to_csv( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/HMG_AutismSpec_A_ADOS_New/Polished_Data_List.csv' )
...
est_beta0.Write( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/HMG_AutismSpec_A_ADOS_New/est_beta0.pt')

# beta1 * s
est_beta1 = tangent_intercept_arr[ 0 ]
est_beta1.Write( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/HMG_AutismSpec_A_ADOS_New/est_beta1.tVec')

# beta2 * ADOS
est_beta2 = tangent_intercept_arr[ 1 ]
est_beta2.Write( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/HMG_AutismSpec_A_ADOS_New/est_beta2.tVec')

# beta3 * autism
est_beta3 = tangent_intercept_arr[ 2 ]
est_beta3.Write( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/HMG_AutismSpec_A_ADOS_New/est_beta3.tVec')

# gamma0 t
est_gamma0 = tangent_slope_arr[ 3 ]
est_gamma0.Write( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/HMG_AutismSpec_A_ADOS_New/est_gamma0.tVec')

# gamma1 * s t
est_gamma1 = tangent_slope_arr[ 0 ]
est_gamma1.Write( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/HMG_AutismSpec_A_ADOS_New/est_gamma1.tVec')

# gamma2 * ADOS t
est_gamma2 = tangent_slope_arr[ 1 ]
est_gamma2.Write( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/HMG_AutismSpec_A_ADOS_New/est_gamma2.tVec')

# gamma3 * autism t
est_gamma3 = tangent_slope_arr[ 2 ]
est_gamma3.Write( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/HMG_AutismSpec_A_ADOS_New/est_gamma3.tVec')

# # Read 
# est_beta0 = manifolds.kendall2D( nPt )
# est_beta0.Read( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/HMG_AutismSpec_A_ADOS_New/est_beta0.pt' )

# est_beta1 = manifolds.kendall2D_tVec( nPt )
# est_beta1.Read( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/HMG_AutismSpec_A_ADOS_New/est_beta1.tVec' )

# est_beta2 = manifolds.kendall2D_tVec( nPt )
# est_beta2.Read( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/HMG_AutismSpec_A_ADOS_New/est_beta2.tVec' )

# est_beta3 = manifolds.kendall2D_tVec( nPt )
# est_beta3.Read( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/HMG_AutismSpec_A_ADOS_New/est_beta3.tVec' )

# est_gamma0 = manifolds.kendall2D_tVec( nPt )
# est_gamma0.Read( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/HMG_AutismSpec_A_ADOS_New/est_gamma0.tVec' )

# est_gamma1 = manifolds.kendall2D_tVec( nPt )
# est_gamma1.Read( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/HMG_AutismSpec_A_ADOS_New/est_gamma1.tVec' )

# est_gamma2 = manifolds.kendall2D_tVec( nPt )
# est_gamma2.Read( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/HMG_AutismSpec_A_ADOS_New/est_gamma2.tVec' )

# est_gamma3 = manifolds.kendall2D_tVec( nPt )
# est_gamma3.Read( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/HMG_AutismSpec_A_ADOS_New/est_gamma3.tVec' )
...
# mean_shape.Write( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/HMG_AutismSpec_A_ADOS_New/mean_shape.pt' )

# Read
mean_shape = manifolds.kendall2D( nPt )
mean_shape.Read( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/HMG_AutismSpec_A_ADOS_New/mean_shape.pt' )
...
for i in range( len( shape_list_all ) ):
	...
	for k in range( 2 ):
		for j in range( nPt ):
			beta_i.tVector[ k, j ] = ( est_beta1.tVector[ k, j ] * s_i + est_beta2.tVector[ k, j ] * ADOS_i + est_beta3.tVector[ k, j ] * autism_i )
	...
	for k in range( 2 ):
		for j in range( nPt ):
			gamma_i.tVector[ k, j ] = ( gamma0_p1_i.tVector[ k, j ] + gamma1_p1_i.tVector[ k, j ] * s_i + gamma2_p1_i.tVector[ k, j ] * ADOS_i + gamma3_p1_i.tVector[ k, j ] * autism_i ) * t_i
...
for s in range( 2 ):
	for autism in range( 2 ):
		for ados in range( 11 ):
			beta_i = manifolds.kendall2D_tVec( nPt )

			for k in range( 2 ):
				for j in range( nPt ):
					beta_i.tVector[ k, j ] = ( est_beta1.tVector[ k, j ] * s + est_beta2.tVector[ k, j ] * ados + est_beta3.tVector[ k, j ] * autism )
			...
			for k in range( 2 ):
				for j in range( nPt ):
					gamma_i.tVector[ k, j ] = ( gamma0_p1_i.tVector[ k, j ] + gamma1_p1_i.tVector[ k, j ] * s + gamma2_p1_i.tVector[ k, j ] * ados + gamma3_p1_i.tVector[ k, j ] * autism )
			...
			plt.savefig( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/HMG_AutismSpec_A_ADOS_New/results_s' + str( s ) + 'Autism' + str( autism ) + 'ADOS' + str( ados ) + '.png' )
			plt.close()
...
for i_t in range( 11 ):
	...
	for autism in range( 2 ):
		for s in range( 2 ):
			...
			plt.savefig( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/HMG_AutismSpec_A_ADOS_New/results_' + 's'+ str( s ) + 't' + str( i_t ) + '.png' )
			plt.close()
...
for i in range( len( shape_age_list_a ) ):
	...
	for j in range( len( shape_list_i ) ):
		...
		plt.savefig( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/HMG_AutismSpec_A_ADOS_New/Subjects/' + subj_ij + "_" + visit_label_ij + "_s" + str( s_ij ) + "Autism" + str( autism_ij ) + "ADOS" + str( ados_ij ) + '.png' )
		plt.close()
