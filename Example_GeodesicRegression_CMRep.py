...
base, tangent = rsm.GeodesicRegression( ageList, CMRepDataList, max_iter, step_size, step_tol, False )

base.Write( "CMRep_GeodesicREgression_CTRL_base.rpt" )
tangent.Write( "CMRep_GeodesicREgression_CTRL_tangent.tVec" )
...
regression_output_folder_path = '/media/shong/IntHard1/4DAnalysis/IPMI2018/GeodesicRegressionResults/CMRep_CTRL_Group_NewCode/'
