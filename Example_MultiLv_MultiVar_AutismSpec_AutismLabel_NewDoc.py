...
data_list_pd.to_csv( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/HMG_AutismSpecOnly_Autism_New/Polished_Data_List.csv' )
...
est_beta0.Write( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/HMG_AutismSpecOnly_Autism_New/est_beta0.pt')

# beta1 * s
est_beta1 = tangent_intercept_arr[ 0 ]
est_beta1.Write( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/HMG_AutismSpecOnly_Autism_New/est_beta1.tVec')

# beta2 * a
est_beta2 = tangent_intercept_arr[ 1 ]
est_beta2.Write( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/HMG_AutismSpecOnly_Autism_New/est_beta2.tVec')

# gamma0 t
est_gamma0 = tangent_slope_arr[ 2 ]
est_gamma0.Write( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/HMG_AutismSpecOnly_Autism_New/est_gamma0.tVec')

# gamma1 * s t
est_gamma1 = tangent_slope_arr[ 0 ]
est_gamma1.Write( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/HMG_AutismSpecOnly_Autism_New/est_gamma1.tVec')

# gamma2 * a t
est_gamma2 = tangent_slope_arr[ 1 ]
est_gamma2.Write( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/HMG_AutismSpecOnly_Autism_New/est_gamma2.tVec')

# # Read 
# est_beta0 = manifolds.kendall2D( nPt )
# est_beta0.Read( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/HMG_AutismSpecOnly_Autism_New/est_beta0.pt' )

# est_beta1 = manifolds.kendall2D_tVec( nPt )
# est_beta1.Read( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/HMG_AutismSpecOnly_Autism_New/est_beta1.tVec' )

# est_beta2 = manifolds.kendall2D_tVec( nPt )
# est_beta2.Read( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/HMG_AutismSpecOnly_Autism_New/est_beta2.tVec' )

# est_gamma0 = manifolds.kendall2D_tVec( nPt )
# est_gamma0.Read( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/HMG_AutismSpecOnly_Autism_New/est_gamma0.tVec' )

# est_gamma1 = manifolds.kendall2D_tVec( nPt )
# est_gamma1.Read( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/HMG_AutismSpecOnly_Autism_New/est_gamma1.tVec' )

# est_gamma2 = manifolds.kendall2D_tVec( nPt )
# est_gamma2.Read( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/HMG_AutismSpecOnly_Autism_New/est_gamma2.tVec' )
...
# mean_shape.Write( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/HMG_AutismSpecOnly_Autism_New/mean_shape.pt' )
...
for i in range( len( shape_list_all ) ):
	...
	for k in range( 2 ):
		for j in range( nPt ):
			beta_i.tVector[ k, j ] = ( est_beta1.tVector[ k, j ] * s_i + est_beta2.tVector[ k, j ] * autism_i )
	...
	for k in range( 2 ):
		for j in range( nPt ):
			gamma_i.tVector[ k, j ] = ( gamma0_p1_i.tVector[ k, j ] + gamma1_p1_i.tVector[ k, j ] * s_i + gamma2_p1_i.tVector[ k, j ] * autism_i ) * t_i
...
for i in range( len( shape_list_a ) ):
	...
	for j in range( 2 ):
		for k in range( nPt ):
			beta_i.tVector[ j, k ] = ( est_beta1.tVector[ j, k ] * s_i + est_beta2.tVector[ j, k ] * a_i )
...
for i in range( len( subj_slope_list ) ):
	...
	for j in range( 2 ):
		for k in range( nPt ):
			gamma_i.tVector[ j, k ] = ( est_gamma0.tVector[ j, k ] + est_gamma1.tVector[ j, k ] * s_i + est_gamma2.tVector[ j, k ] * a_i ) 
...
for s in range( 2 ):
	for ados in range( 2 ):
		...
		for k in range( 2 ):
			for j in range( nPt ):
				beta_i.tVector[ k, j ] = ( est_beta1.tVector[ k, j ] * s + est_beta2.tVector[ k, j ] * ados )
		...
		for k in range( 2 ):
			for j in range( nPt ):
				gamma_i.tVector[ k, j ] = ( gamma0_p1_i.tVector[ k, j ] + gamma1_p1_i.tVector[ k, j ] * s + gamma2_p1_i.tVector[ k, j ] * ados )
		...
		plt.savefig( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/HMG_AutismSpecOnly_Autism_New/results_s' + str( s ) + 'a' + str( ados ) + '.png' )
		plt.close()
...
for i_t in range( 11 ):
	...
	for s in range( 2 ):
		...
		plt.savefig( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/HMG_AutismSpecOnly_ADOS_New/results_' + 's'+ str( s ) + 't' + str( i_t ) + '.png' )
		plt.close()
...
for i in range( len( shape_age_list_a ) ):
	...
	for j in range( len( shape_list_i ) ):
		...
		for kk in range( 2 ):
			for jj in range( nPt ):
				beta_ij.tVector[ kk, jj ] = ( est_beta1.tVector[ kk, jj ] * s_ij + est_beta2.tVector[ kk, jj ] * autism_ij )
		...
		for kk in range( 2 ):
			for jj in range( nPt ):
				gamma_ij.tVector[ kk, jj ] = ( gamma0_p1_i.tVector[ kk, jj ] + gamma1_p1_i.tVector[ kk, jj ] * s_ij + gamma2_p1_i.tVector[ kk, jj ] * autism_ij ) * age_ij
		...
		plt.savefig( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/HMG_AutismSpecOnly_Autism_New/Subjects/' + subj_ij + "_" + visit_label_ij + "_s" + str( s_ij ) + "a" + str( autism_ij ) + '.png' )
		plt.close()
'''
