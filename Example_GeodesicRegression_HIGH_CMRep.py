...
base.Write( "CMRep_GeodesicREgression_HIGH_base.rpt" )
tangent.Write( "CMRep_GeodesicREgression_HIGH_tangent.tVec" )
...
regression_output_folder_path = '/media/shong/IntHard1/4DAnalysis/IPMI2018/GeodesicRegressionResults/CMRep_HIGH_Group_NewCode/'
