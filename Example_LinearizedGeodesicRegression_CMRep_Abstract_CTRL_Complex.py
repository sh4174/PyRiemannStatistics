...
for a, anatomy in enumerate( anatomy_list ):
	...
	regression_output_folder_path = '/media/shong/IntHard1/4DAnalysis/IPMI2019/GeodesicRegressionResults/CMRep_Abstract_CTRL_Group_NewCode_Linearized_Complex/Subjects/'
