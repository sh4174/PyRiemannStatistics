...
RMSE_overall =rsm.RootMeanSquaredError_CMRep_Abstract_Array( ageList, CMRepDataList, base_arr, tangent_arr ) 

R2_overall = rsm.R2Statistics_CMRep_Abstract_Array( ageList, CMRepDataList, base_arr, tangent_arr )
...
for a, anatomy in enumerate( anatomy_list ):
	...
	R2 = rsm.R2Statistics( ageList, CMRepDataList[a], base, tangent ) 

	print( "Anatomy R2 Statistics" ) 
	print( R2 ) 

	RMSE = rsm.RootMeanSquaredError( ageList, CMRepDataList[a], base, tangent )

	print( "Anatomy RMSE" )
	print( RMSE )

	R2_atom, RMSE_atom = rsm.R2Statistics_CMRep_Abstract_Atom( ageList, CMRepDataList[a], base, tangent ) 
	R2_atom_overall.append( R2_atom )
	RMSE_atom_overall.append( RMSE_atom )
	...
	print( "Position Abstract - SO( 3(n-1) )" )
	print( R2_atom[ 2 ] ) 

	print( "Atom-wise R2 Statistics")
	print( "Position")
	print( "Maximum" ) 
	print( np.max( R2_atom[ 3 ] ) )
	print( "Minimum" )
	print( np.min( R2_atom[ 3 ] ) )
	print( "Standard Deviation" )
	print( np.std( R2_atom[ 3 ] ) )
	print( "Average" )
	print( np.average( R2_atom[ 3 ] ) )

	print( "Radius")
	print( "Maximum" ) 
	print( np.max( R2_atom[ 4 ] ) )
	print( "Minimum" )
	print( np.min( R2_atom[ 4 ] ) )
	print( "Standard Deviation" )
	print( np.std( R2_atom[ 4 ] ) )
	print( "Average" )
	print( np.average( R2_atom[ 4 ] ) )
	...
	print( "Position")
	print( "Maximum" ) 
	print( np.max( RMSE_atom[ 3 ] ) )
	print( "Minimum" )
	print( np.min( RMSE_atom[ 3 ] ) )
	print( "Standard Deviation" )
	print( np.std( RMSE_atom[ 3 ] ) )
	print( "Average" )
	print( np.average( RMSE_atom[ 3 ] ) )

	print( "Radius")
	print( "Maximum" ) 
	print( np.max( RMSE_atom[ 4 ] ) )
	print( "Minimum" )
	print( np.min( RMSE_atom[ 4 ] ) )
	print( "Standard Deviation" )
	print( np.std( RMSE_atom[ 4 ] ) )
	print( "Average" )
	print( np.average( RMSE_atom[ 4 ] ) )
	...
	for n in range( nTimePt ):
		outFileName = 'CMRep_Abstract_Regression_CTRL_' + anatomy + '_' + str( n ) + '.vtk' 
		outAbstFileName = 'CMRep_Abstract_Regression_CTRL_' + anatomy + '_' + str( n ) + '_Abstract_Position.vtk'  
