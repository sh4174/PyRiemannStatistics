...
ptInitActor.GetProperty().SetPointSize( 19 )
ptInitActor.GetProperty().SetColor( 1, 0, 1 )
...
estLineActor.GetProperty().SetColor( 0.4, 0.7, 0.9 )
...
estLineActor_LReg.GetProperty().SetColor( 0.340, 0.023,0.547 )
...
estLineActor_LReg1.GetProperty().SetColor( 0.340, 0.023,0.547 )
...
estLineActor_LReg2.GetProperty().SetColor( 0.340, 0.023,0.547 )
...
estLineActor_LReg3.GetProperty().SetColor( 0.340, 0.023,0.547 )
...
estLineActor_LReg4.GetProperty().SetColor( 0.340, 0.023,0.547 )
...
# Final Estimation
ren.RemoveActor( estLineActor_LReg4 )
