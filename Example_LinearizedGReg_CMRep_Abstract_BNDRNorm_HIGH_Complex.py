...
for a, anatomy in enumerate( anatomy_list ):
	...
	mu.Write( "CMRep_Abstract_LinearizedGeodesicRegression_HIGH_FrechetMean_" + anatomy +".rpt" )
...
# R2_overall_g = rsm.R2Statistics_CMRep_Abstract_Array( ageList, CMRepDataList, base_arr_g, tangent_arr_g )
...
for a, anatomy in enumerate( anatomy_list ):
	...
	base_arr[ a ].Write( "CMRep_Abstract_Normal_LinearizedGeodesicRegression_HIGH_" + anatomy + "_base.rpt" )
	tangent_arr[ a ].Write( "CMRep_Abstract_Normal_LinearizedGeodesicRegression_HIGH_" + anatomy + "_tangent.tVec" )
	...
	base.Read( "CMRep_Abstract_Normal_LinearizedGeodesicRegression_HIGH_" + anatomy + "_base.rpt" )

	tangent = manifolds.cmrep_abstract_normal_tVec( nManDim ) 
	tangent.Read( "CMRep_Abstract_Normal_LinearizedGeodesicRegression_HIGH_" + anatomy + "_tangent.tVec" )
	...
	regression_output_folder_path = '/media/shong/IntHard1/4DAnalysis/IPMI2019/GeodesicRegressionResults/CMRep_Abstract_Normal_HIGH_Group_NewCode_Linearized_Complex/'
	...
	for n in range( nTimePt ):
		outFileName = 'CMRep_Abstract_Normal_Regression_HIGH_' + anatomy + '_' + str( n ) + '.vtk' 
		outAbstFileName = 'CMRep_Abstract_Normal_Regression_HIGH_' + anatomy + '_' + str( n ) + '_Abstract_Position.vtk'  
