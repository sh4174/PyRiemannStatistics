...
base.Write( "CMRep_LinearizedGeodesicRegression_Complex_CTRL_base.rpt" )
tangent.Write( "CMRep_LinearizedGeodesicRegression_Complex_CTRL_tangent.tVec" )
...
for n in range( nTimePt ):
	...
	for a in range( len( anatomy_list ) ):
		...
		outFileName = 'CMRep_Regression_CTRL_Comlex_' + anatomy + '_' + str( n ) + '.vtk' 
