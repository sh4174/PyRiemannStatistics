...
data_list_pd.to_csv( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/HMG_HR_A_ADOS_New/Polished_Data_List.csv' )
...
est_beta0.Write( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/HMG_HR_A_ADOS_New/est_beta0.pt')

# beta1 * s
est_beta1 = tangent_intercept_arr[ 0 ]
est_beta1.Write( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/HMG_HR_A_ADOS_New/est_beta1.tVec')

# beta2 * a
est_beta2 = tangent_intercept_arr[ 1 ]
est_beta2.Write( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/HMG_HR_A_ADOS_New/est_beta2.tVec')

# beta3 * ADOS
est_beta3 = tangent_intercept_arr[ 2 ]
est_beta3.Write( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/HMG_HR_A_ADOS_New/est_beta3.tVec')

# gamma0 t
est_gamma0 = tangent_slope_arr[ 3 ]
est_gamma0.Write( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/HMG_HR_A_ADOS_New/est_gamma0.tVec')

# gamma1 * s t
est_gamma1 = tangent_slope_arr[ 0 ]
est_gamma1.Write( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/HMG_HR_A_ADOS_New/est_gamma1.tVec')

# gamma2 * a t
est_gamma2 = tangent_slope_arr[ 1 ]
est_gamma2.Write( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/HMG_HR_A_ADOS_New/est_gamma2.tVec')

# gamma3 * ADOS t
est_gamma3 = tangent_slope_arr[ 2 ]
est_gamma3.Write( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/HMG_HR_A_ADOS_New/est_gamma3.tVec')


# # Read 
# est_beta0 = manifolds.kendall2D( nPt )
# est_beta0.Read( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/HMG_HR_A_ADOS_New/est_beta0.pt' )

# est_beta1 = manifolds.kendall2D_tVec( nPt )
# est_beta1.Read( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/HMG_HR_A_ADOS_New/est_beta1.tVec' )

# est_beta2 = manifolds.kendall2D_tVec( nPt )
# est_beta2.Read( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/HMG_HR_A_ADOS_New/est_beta2.tVec' )

# est_gamma0 = manifolds.kendall2D_tVec( nPt )
# est_gamma0.Read( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/HMG_HR_A_ADOS_New/est_gamma0.tVec' )

# est_gamma1 = manifolds.kendall2D_tVec( nPt )
# est_gamma1.Read( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/HMG_HR_A_ADOS_New/est_gamma1.tVec' )

# est_gamma2 = manifolds.kendall2D_tVec( nPt )
# est_gamma2.Read( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/HMG_HR_A_ADOS_New/est_gamma2.tVec' )

# est_gamma3 = manifolds.kendall2D_tVec( nPt )
# est_gamma3.Read( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/HMG_HR_A_ADOS_New/est_gamma3.tVec' )
...
mean_shape.Write( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/HMG_HR_A_ADOS_New/mean_shape.pt' )

# # Read
# mean_shape = manifolds.kendall2D( nPt )
# mean_shape.Read( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/HMG_HR_A_ADOS_New/mean_shape.pt' )
...
for s in range( 2 ):
	for a in range( 2 ):
		for i_as in range( 11 ):
			...
			plt.savefig( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/HMG_HR_A_ADOS_New/results_s' + str( s ) + 'a' + str( a ) + 'ADOS' + str( i_as ) + '.png' )
			plt.close()
	...
	for s in range( 2 ):
		...
		for i_as in range( 11 ):
			for a in range( 2 ):
				...
				plt.plot( x_t, y_t, color=colors_2[ a ].rgb, alpha=0.6, label=("s" + str( s ) + "a" + str( a ) + str( "ADOS " ) + str( i_as ) ) )
				# plt.legend()

			plt.savefig( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/HMG_HR_A_ADOS_New/results_' + 's'+ str( s ) + 't' + str( i_t ) + '.png' )
			plt.close()
...
for i in range( len( shape_age_list_a ) ):
	...
	for j in range( len( shape_list_i ) ):
		...
		for kk in range( 2 ):
			for jj in range( nPt ):
				beta_ij.tVector[ kk, jj ] = ( est_beta1.tVector[ kk, jj ] * s_ij + est_beta2.tVector[ kk, jj ] * autism_ij + est_beta3.tVector[ kk, jj ] * ados_ij )
		...
		for kk in range( 2 ):
			for jj in range( nPt ):
				gamma_ij.tVector[ kk, jj ] = ( gamma0_p1_i.tVector[ kk, jj ] + gamma1_p1_i.tVector[ kk, jj ] * s_ij + gamma2_p1_i.tVector[ kk, jj ] * autism_ij + gamma3_p1_i.tVector[ kk, jj ] * ados_ij ) * age_ij
		...
		plt.savefig( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/HMG_HR_A_ADOS_New/Subjects/' + subj_ij + "_" + visit_label_ij + "_s" + str( s_ij ) + "a" + str( autism_ij ) + "ADOS" + str( ados_ij ) + '.png' )
		plt.close()
