...
plt.scatter( t_list_a, pt_list_a, c= [ 0.4, 0.7, 0.9], label="Observations" )
plt.plot( est_t_list, est_pt_list, c= [0.340, 0.023,0.547], linestyle="-", linewidth=4, label="Estimated \nTrend" )
plt.xlabel('Age(year)') 
plt.ylabel('Rad(mm)' )
plt.legend()
plt.tight_layout()
