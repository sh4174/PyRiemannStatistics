...
# est_beta0.Write( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/HMG_AutismSpecOnly_ADOS_New/est_beta0.pt')

# # beta1 * s
# est_beta1 = tangent_intercept_arr[ 0 ]
# est_beta1.Write( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/HMG_AutismSpecOnly_ADOS_New/est_beta1.tVec')

# # beta2 * ADOS
# est_beta2 = tangent_intercept_arr[ 1 ]
# est_beta2.Write( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/HMG_AutismSpecOnly_ADOS_New/est_beta2.tVec')

# # gamma0 t
# est_gamma0 = tangent_slope_arr[ 2 ]
# est_gamma0.Write( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/HMG_AutismSpecOnly_ADOS_New/est_gamma0.tVec')
...
est_beta0.Read( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/HMG_AutismSpecOnly_ADOS_New/est_beta0.pt' )

est_beta1 = manifolds.kendall2D_tVec( nPt )
est_beta1.Read( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/HMG_AutismSpecOnly_ADOS_New/est_beta1.tVec' )

est_beta2 = manifolds.kendall2D_tVec( nPt )
est_beta2.Read( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/HMG_AutismSpecOnly_ADOS_New/est_beta2.tVec' )

est_gamma0 = manifolds.kendall2D_tVec( nPt )
est_gamma0.Read( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/HMG_AutismSpecOnly_ADOS_New/est_gamma0.tVec' )

est_gamma1 = manifolds.kendall2D_tVec( nPt )
est_gamma1.Read( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/HMG_AutismSpecOnly_ADOS_New/est_gamma1.tVec' )

est_gamma2 = manifolds.kendall2D_tVec( nPt )
est_gamma2.Read( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/HMG_AutismSpecOnly_ADOS_New/est_gamma2.tVec' )
...
# 		plt.savefig( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/HMG_AutismSpecOnly_ADOS_New/results_s' + str( s ) + 'ADOS' + str( ados ) + '.png' )
# 		plt.close()
...
# 		plt.savefig( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/HMG_AutismSpecOnly_ADOS_New/Subjects/' + subj_ij + "_" + visit_label_ij + "_s" + str( s_ij ) + "ADOS" + str( ados_ij ) + '.png' )
# 		plt.close()
