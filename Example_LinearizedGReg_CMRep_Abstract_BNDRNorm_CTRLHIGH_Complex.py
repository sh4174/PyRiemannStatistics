...
for a, anatomy in enumerate( anatomy_list ):
	...
	base_arr[ a ].Write( "CMRep_Abstract_Normal_LinearizedGeodesicRegression_CTRLHIGH_" + anatomy + "_base.rpt" )
	tangent_arr[ a ].Write( "CMRep_Abstract_Normal_LinearizedGeodesicRegression_CTRLHIGH_" + anatomy + "_tangent.tVec" )
	...
	base.Read( "CMRep_Abstract_Normal_LinearizedGeodesicRegression_CTRLHIGH_" + anatomy + "_base.rpt" )

	tangent = manifolds.cmrep_abstract_normal_tVec( nManDim ) 
	tangent.Read( "CMRep_Abstract_Normal_LinearizedGeodesicRegression_CTRLHIGH_" + anatomy + "_tangent.tVec" )
	...
	regression_output_folder_path = '/media/shong/IntHard1/4DAnalysis/IPMI2019/GeodesicRegressionResults/CMRep_Abstract_Normal_CTRLHIGH_Group_NewCode_Linearized_Complex/'
	...
	for n in range( nTimePt ):
		outFileName = 'CMRep_Abstract_Normal_Regression_CTRLHIGH_' + anatomy + '_' + str( n ) + '.vtk' 
		outAbstFileName = 'CMRep_Abstract_Normal_Regression_CTRLHIGH_' + anatomy + '_' + str( n ) + '_Abstract_Position.vtk'  
