...
for i in range( nSubject ):
	...
	p0_i_mean = p0.ExponentialMap( v0.ScalarMultiply( c_i * subj_init_time ) )
	...
	# p1_i
	# v_i = p0_i.ParallelTranslateAtoB( p0, p0_i, v0 ).ScalarMultiply( c_i * subj_time_interval )
	v_i = p0_i_mean.ParallelTranslateAtoB( p0_i_mean, p0_i, p0.ParallelTranslateAtoB( p0, p0_i_mean, v0 ) ).ScalarMultiply( c_i * subj_time_interval )
...
for i in range( nSubject ):
	...
	p0_mean_t0 = p0_mean.ExponentialMap( v0_mean.ScalarMultiply( subj_t0 ) )

	# Parallel Transport v0_mean to the subject-wise interpolation point
	v0_i = p0_mean_t0.ParallelTranslateAtoB( p0_mean_t0, p0_t0, p0_mean.ParallelTranslateAtoB( p0_mean, p0_mean_t0, v0_mean ) ).ScalarMultiply( subj_time_interval_i )
