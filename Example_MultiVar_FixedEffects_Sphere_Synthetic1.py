...
base, tangent_arr = sm.MultivariateLinearizedGeodesicRegression_Sphere( group_ind_var_list, group_pt_list, VG, max_iter=5 )
...
print( "est_beta_2" )
print( est_beta_2.tVector )

print( "est_beta_2_tilde" )
print( est_beta_2_tilde.tVector )
...
for t in range( nLineTimePt ):
	...
	# # v_t2.SetTangentVector( [ tangent_arr[ 1 ].tVector[ 0 ] * time_pt, tangent_arr[ 1 ].tVector[ 1 ] * time_pt, tangent_arr[ 1 ].tVector[ 2 ] * time_pt ] )

	v_t2 = est_beta_2_tilde.ScalarMultiply( time_pt )
