...
beta3.SetTangentVector( [ 0.0, 0.005, -0.002 ] )
...
for i in range( nData_1 ):
	...
	group1_cov_slope_list.append( cov_i )
...
for i in range( nData_1 ):
	...
	group2_cov_slope_list.append( cov_i )
...
beta0, tangent_intercept_arr, tangent_slope_arr = sm.MultivariateLinearizedGeodesicRegression_Sphere_BottomUp( t_list, pt_list, cov_int_list, cov_slope_list, max_iter=10, verbose=False )
...
estGroupGeodesicActor2.GetProperty().SetLineWidth( 15 )
estGroupGeodesicActor2.GetProperty().SetColor( group_est_color[ 1 ] )
estGroupGeodesicActor2.GetProperty().SetOpacity( 0.5 )
