...
base.Write( "CMRep_Abstract_LinearizedGeodesicRegression_CTRL_LC_base.rpt" )
tangent.Write( "CMRep_Abstract_LinearizedGeodesicRegression_CTRL_LC_tangent.tVec" )
...
R2_atom, RMSE_atom = rsm.R2Statistics_CMRep_Abstract_Atom( ageList, CMRepDataList, base, tangent ) 
...
print( "Local Position Euclidean - 101st Atom")
print( R2_atom[ 3 ][ 100 ] )

print( "Local Rad Positive Real - 101st Atom")
print( R2_atom[ 4 ][ 100 ] )
...
print( "Local Position Euclidean - 101st Atom")
print( RMSE_atom[ 3 ][ 100 ] )

print( "Local Rad Positive Real - 101st Atom")
print( RMSE_atom[ 4 ][ 100 ] )
