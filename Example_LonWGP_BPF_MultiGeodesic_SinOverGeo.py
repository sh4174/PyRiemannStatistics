...
green = Color( "red" )
colors_2 = list( green.range_to( Color( "yellow" ), nSubj ) ) 

# Visualize Subject-Specific Data 
actorArr = []
...
for i in range( nSubj ):	
	...
	time_list_i = time_list[ i ] 

	for j in range( nData_subj ):
		points_i.InsertNextPoint( data_list_i[ j ].pt[ 0 ], data_list_i[ j ].pt[ 1 ], data_list_i[ j ].pt[ 2 ] )
