...
# Model - y = ( beta_0 + beta_1 s + beta_2 c ) + beta_3 t + beta_4 st						   #	
...
for c in range( nCAG_Lines ):
	...
	for t in range( nLineTimePt ):
		...
		v_t.SetTangentVector( [ beta3_tilde.tVector[ 0 ] * time_pt, beta3_tilde.tVector[ 1 ] * time_pt, beta3_tilde.tVector[ 2 ] * time_pt ] )
...
for c in range( nCAG_Lines ):
	...
	for t in range( nLineTimePt ):
		...
		v_t = manifolds.sphere_tVec( nDimManifold )
		v_t.SetTangentVector( [ ( beta_3_at_p_1_c.tVector[ 0 ] + beta_4_at_p_1_c.tVector[ 0 ] ) * time_pt, ( beta_3_at_p_1_c.tVector[ 1 ] + beta_4_at_p_1_c.tVector[ 1 ] ) * time_pt, ( beta_3_at_p_1_c.tVector[ 2 ] + beta_4_at_p_1_c.tVector[ 2 ] ) * time_pt ] )
	...
	for g in range( nCAG_Lines ):
		...
		for i in range( nData_g ):
			...
			for d in range( nDimManifold ):
				v_t_i.tVector[ d ] = ( beta_3_at_p_1_c.tVector[ d ] + beta_4_at_p_1_c_s.tVector[ d ] ) * t_i
...
est_beta3.SetTangentVector( tangent_slope_arr[ 1 ].tVector )
