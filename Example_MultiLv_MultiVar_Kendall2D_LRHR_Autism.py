	...
	for j in range( len( subj_set ) ):
		if subj_i == subj_set[ j ]:
			...
			if shape_nObs_list[ j ] == 0:
				cov_int_list[ j ] = [ s_i, hr_i, autism_i ]

				cov_slope_list[ j ] = [ s_i, hr_i, autism_i ]
...
data_list_pd.to_csv( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/MLMG_LRHR_Autism/Polished_Data_List.csv' )
...
est_beta0.Write( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/MLMG_LRHR_Autism/est_beta0.pt')

# beta1 * s
est_beta1 = tangent_intercept_arr[ 0 ]
est_beta1.Write( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/MLMG_LRHR_Autism/est_beta1.tVec')

# beta2 * hr
est_beta2 = tangent_intercept_arr[ 1 ]
est_beta2.Write( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/MLMG_LRHR_Autism/est_beta2.tVec')

# beta3 * autism
est_beta3 = tangent_intercept_arr[ 2 ]
est_beta3.Write( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/MLMG_LRHR_Autism/est_beta3.tVec')

# gamma0 t
est_gamma0 = tangent_slope_arr[ 3 ]
est_gamma0.Write( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/MLMG_LRHR_Autism/est_gamma0.tVec')

# gamma1 * s t
est_gamma1 = tangent_slope_arr[ 0 ]
est_gamma1.Write( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/MLMG_LRHR_Autism/est_gamma1.tVec')

# gamma2 * hr t
est_gamma2 = tangent_slope_arr[ 1 ]
est_gamma2.Write( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/MLMG_LRHR_Autism/est_gamma2.tVec')

# gamma3 * autism t
est_gamma3 = tangent_slope_arr[ 2 ]
est_gamma3.Write( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/MLMG_LRHR_Autism/est_gamma3.tVec')
...
# est_beta0.Read( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/MLMG_LRHR_Autism/est_beta0.pt' )

# est_beta1 = manifolds.kendall2D_tVec( nPt )
# est_beta1.Read( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/MLMG_LRHR_Autism/est_beta1.tVec' )

# est_beta2 = manifolds.kendall2D_tVec( nPt )
# est_beta2.Read( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/MLMG_LRHR_Autism/est_beta2.tVec' )

# est_beta3 = manifolds.kendall2D_tVec( nPt )
# est_beta3.Read( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/MLMG_LRHR_Autism/est_beta3.tVec' )


# est_gamma0 = manifolds.kendall2D_tVec( nPt )
# est_gamma0.Read( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/MLMG_LRHR_Autism/est_gamma0.tVec' )

# est_gamma1 = manifolds.kendall2D_tVec( nPt )
# est_gamma1.Read( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/MLMG_LRHR_Autism/est_gamma1.tVec' )

# est_gamma2 = manifolds.kendall2D_tVec( nPt )
# est_gamma2.Read( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/MLMG_LRHR_Autism/est_gamma2.tVec' )

# est_gamma3 = manifolds.kendall2D_tVec( nPt )
# est_gamma3.Read( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/MLMG_LRHR_Autism/est_gamma3.tVec' )
...
# mean_shape.Write( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/MLMG_LRHR_Autism/mean_shape.pt' )

# Read
mean_shape = manifolds.kendall2D( nPt )
mean_shape.Read( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/MLMG_LRHR_Autism/mean_shape.pt' )
...
for i in range( len( shape_list_all ) ):
	...
	for k in range( 2 ):
		for j in range( nPt ):
			beta_i.tVector[ k, j ] = ( est_beta1.tVector[ k, j ] * s_i + est_beta2.tVector[ k, j ] * hr_i + est_beta3.tVector[ k, j ] * autism_i )
	...
	for k in range( 2 ):
		for j in range( nPt ):
			gamma_i.tVector[ k, j ] = ( gamma0_p1_i.tVector[ k, j ] + gamma1_p1_i.tVector[ k, j ] * s_i + gamma2_p1_i.tVector[ k, j ] * hr_i + gamma3_p1_i.tVector[ k, j ] * autism_i ) * t_i
...
for s in range( 2 ):
	for aut in range( 2 ):
		for LRHR in range( 2 ):
			...
			for k in range( 2 ):
				for j in range( nPt ):
					beta_i.tVector[ k, j ] = ( est_beta1.tVector[ k, j ] * s + est_beta2.tVector[ k, j ] * LRHR + est_beta3.tVector[ k, j ] * aut )
			...
			for k in range( 2 ):
				for j in range( nPt ):
					gamma_i.tVector[ k, j ] = ( gamma0_p1_i.tVector[ k, j ] + gamma1_p1_i.tVector[ k, j ] * s + gamma2_p1_i.tVector[ k, j ] * LRHR + gamma3_p1_i.tVector[ k, j ] * aut )
			...
			for i_t in range( 101 ):
				...
				plt.plot( x_t, y_t, color=colors[ i_t ].rgb )

			plt.savefig( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/MLMG_LRHR_Autism/results_s' + str( s ) + 'aut' + str( aut ) + 'HR' + str( LRHR ) + '.png' )


red = Color( "red" )
colors_2 = list( red.range_to( Color( "blue" ), 8 ) ) 
	...
	for s in range( 2 ):
		for aut in range( 2 ):
			for LRHR in range( 2 ):
				...
				plt.plot( x_t, y_t, color=colors_2[ s * 4 + aut * 2 + LRHR ].rgb, label=("s" + str( s ) + "aut" + str( aut ) + "HR" + str( LRHR ) ) )
				plt.legend()

	plt.savefig( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/MLMG_LRHR_Autism/results_t_' + str( t ) + '.png' )
