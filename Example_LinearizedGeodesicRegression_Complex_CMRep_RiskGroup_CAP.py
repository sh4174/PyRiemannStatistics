...
base.Write( "CMRep_LinearizedGeodesicRegression_Complex_Risk_CAP_base.rpt" )
tangent.Write( "CMRep_LinearizedGeodesicRegression_Complex_Risk_CAP_tangent.tVec" )
...
regression_output_folder_path = '/media/shong/IntHard1/4DAnalysis/IPMI2018/GeodesicRegressionResults/CMRep_RiskGroup_Complex_NewCode_Linearized_CAP/'
...
for n in range( nTimePt ):
	...
	for a, anatomy in enumerate( anatomy_list ):
		...
		outFileName = 'CMRep_Regression_Risk_CAP_Comlex_' + anatomy + '_' + str( n ) + '.vtk' 
