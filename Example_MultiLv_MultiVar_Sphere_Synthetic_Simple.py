...
for j in range( len( group_vtk_list_s1 ) ):
	...
	group_geodesic_actor = vtk.vtkActor()
	group_geodesic_actor.SetMapper( group_geodesic_mapper )
	group_geodesic_actor.GetProperty().SetColor( [ 255.0, 255.0, 0.0 ] )
	group_geodesic_actor.GetProperty().SetOpacity( 0.6 )
	group_geodesic_actor.GetProperty().SetLineWidth( 25 )
	group_geodesic_actor.GetProperty().SetRenderLinesAsTubes( 0 )
...
for j in range( len( est_group_vtk_list_s1 ) ):
	...
	estGroupGeodesicActor.GetProperty().SetOpacity( 0.8 )
