...
for a, anatomy in enumerate( anatomy_list ):
	...
	regression_output_folder_path = '/media/shong/IntHard1/4DAnalysis/IPMI2019/GeodesicRegressionResults/CMRep_Abstract_Normal_HIGH_Group_NewCode_Linearized_Complex/CenterChange/'

	for n in range( nTimePt ):
		outFileName = 'CMRep_Abstract_Normal_Regression_HIGH_' + anatomy + '_Center_Change_' + str( n ) + '.vtk' 
	...
	# Radius Change
	radius_change_folder_path = '/media/shong/IntHard1/4DAnalysis/IPMI2019/GeodesicRegressionResults/CMRep_Abstract_Normal_HIGH_Group_NewCode_Linearized_Complex/RadiusChange/'

	for n in range( nTimePt ):
		outFileName = 'CMRep_Abstract_Normal_Regression_HIGH_' + anatomy + '_Radius_Change_' + str( n ) + '.vtk' 
	...
	# Bndr Normal1 Change
	normal2_change_folder_path = '/media/shong/IntHard1/4DAnalysis/IPMI2019/GeodesicRegressionResults/CMRep_Abstract_Normal_HIGH_Group_NewCode_Linearized_Complex/BndrNormal1Change/'

	for n in range( nTimePt ):
		outFileName = 'CMRep_Abstract_Normal_Regression_HIGH_' + anatomy + '_BndrNormal1_Change_' + str( n ) + '.vtk' 
