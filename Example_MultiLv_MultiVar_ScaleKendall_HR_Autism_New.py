...
data_list_pd.to_csv( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/HMG_ScaleKendall_HR_A_New/Polished_Data_List.csv' )
...
est_beta0.Write( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/HMG_ScaleKendall_HR_A_New/est_beta0.pt')

# beta1 * s
est_beta1 = tangent_intercept_arr[ 0 ]
est_beta1.Write( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/HMG_ScaleKendall_HR_A_New/est_beta1.tVec')

# beta2 * ADOS
est_beta2 = tangent_intercept_arr[ 1 ]
est_beta2.Write( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/HMG_ScaleKendall_HR_A_New/est_beta2.tVec')

# gamma0 t
est_gamma0 = tangent_slope_arr[ 2 ]
est_gamma0.Write( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/HMG_ScaleKendall_HR_A_New/est_gamma0.tVec')

# gamma1 * s t
est_gamma1 = tangent_slope_arr[ 0 ]
est_gamma1.Write( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/HMG_ScaleKendall_HR_A_New/est_gamma1.tVec')

# gamma2 * ADOS t
est_gamma2 = tangent_slope_arr[ 1 ]
est_gamma2.Write( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/HMG_ScaleKendall_HR_A_New/est_gamma2.tVec')

# # Read 
# est_beta0 = manifolds.scale_kendall2D( nPt )
# est_beta0.Read( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/HMG_ScaleKendall_HR_A_New/est_beta0.pt' )

# est_beta1 = manifolds.scale_kendall2D_tVec( nPt )
# est_beta1.Read( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/HMG_ScaleKendall_HR_A_New/est_beta1.tVec' )

# est_beta2 = manifolds.scale_kendall2D_tVec( nPt )
# est_beta2.Read( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/HMG_ScaleKendall_HR_A_New/est_beta2.tVec' )

# est_gamma0 = manifolds.scale_kendall2D_tVec( nPt )
# est_gamma0.Read( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/HMG_ScaleKendall_HR_A_New/est_gamma0.tVec' )

# est_gamma1 = manifolds.scale_kendall2D_tVec( nPt )
# est_gamma1.Read( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/HMG_ScaleKendall_HR_A_New/est_gamma1.tVec' )

# est_gamma2 = manifolds.scale_kendall2D_tVec( nPt )
# est_gamma2.Read( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/HMG_ScaleKendall_HR_A_New/est_gamma2.tVec' )
...
# mean_shape.Write( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/HMG_ScaleKendall_HR_A_New/mean_shape.pt' )

# Read
mean_shape = manifolds.scale_kendall2D( nPt )
mean_shape.Read( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/HMG_ScaleKendall_HR_ADOS_New/mean_shape.pt' )
...
for s in range( 2 ):
	for ados in range( 2 ):
		...
		plt.savefig( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/HMG_ScaleKendall_HR_A_New/results_s' + str( s ) + 'Autism' + str( ados ) + '.png' )
		plt.close()
...
for i_t in range( 11 ):
	...
	for s in range( 2 ):
		...
		plt.savefig( '/media/shong/IntHard1/Projects/4DShapeAnalysis/Data/ACE_IBIS_CC/Data/HMG_ScaleKendall_HR_A_New/results_' + 's'+ str( s ) + 't' + str( i_t ) + '.png' )
		plt.close()
'''
